...
<body>
	<h1>Karimnagar AQI Prediction</h1>
	<div align="center">
		<h3>Prediction Image</h3>
		<img src="images/karimnagar aqi.png" width="400px" height="400px">
	</div>
	<table>
		...
		<tbody>
			...
			<?php
  // (A) OPEN CSV FILE
  $stream = fopen("AQIdata/karimnagar_aqi_prediction2.csv", "r");
