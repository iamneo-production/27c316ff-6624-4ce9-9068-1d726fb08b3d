...
<body>
	<h1>Warangal AQI Prediction</h1>
	<div align="center">
		<h3>Prediction Image</h3>
		<img src="images/warangal aqi.png" width="400px" height="400px">
	</div>
	<table>
		...
		<tbody>
			<!-- CSV data will be dynamically populated here -->
					<?php
  // (A) OPEN CSV FILE
  $stream = fopen("AQIdata/warangal_aqi_prediction.csv", "r");
